...
abstract class BaseModelGenerator extends BaseGenerator
{
    ...
    final public function getFillableData(): array
    {
    ...
    final public function generateData(array $data = [], bool $onlyFillable = false): array
    {
    ...
    final public function generateDataFromModel(Model $model, array $data = [], bool $onlyFillable = false): array
    {
    ...
    final public function makeModel(array $data = []): Model
    {
        return $this->factory->make($data);
    }

    final public function createModel(array $data = []): Model
    {
